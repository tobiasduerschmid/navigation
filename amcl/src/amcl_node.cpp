...
{
  ROS_ERROR("ROSTIMER. Start main: %i", ros::WallTime::now().toNSec());
  ...
  ROS_ERROR("ROSTIMER. End main: %i", ros::WallTime::now().toNSec());
  return(0);
}
...
{
  ROS_ERROR("ROSTIMER. Start mapReceived: %i", ros::WallTime::now().toNSec());
  ...
  ROS_ERROR("ROSTIMER. End mapReceived: %i", ros::WallTime::now().toNSec());
}
...
{
  ROS_ERROR("ROSTIMER. Start initialPoseReceived: %i", ros::WallTime::now().toNSec());
  handleInitialPoseMessage(*msg);
  ROS_ERROR("ROSTIMER. End initialPoseReceived: %i", ros::WallTime::now().toNSec());
}
